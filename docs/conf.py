...
"""
openedx-events-2-zapier documentation build configuration file.
...
project = "openedx-events-2-zapier"
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = "openedx-events-2-zapier"
...
#
# html_title = 'openedx-events-2-zapier v0.1.0'
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call(
        [
            ...
            "-o",
            docs_path,
            os.path.join(root_path, "openedx_events_2_zapier"),

...
"""
openedx-events-samples documentation build configuration file.
...
project = 'openedx-events-samples'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'openedx-events-samples'
...
#
# html_title = 'openedx-events-samples v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'This repository contains real-life use cases for Open edX Events.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_events_2_zapier'),
                os.path.join(root_path, 'openedx_events_2_zapier/migrations')])
